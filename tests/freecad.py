...
__title__ = "importCcxFrdResults.py"
...
def read_frd_result(frd_input):
    ...
    for line in frd_file:
        ...
        if nodes_found and (line[1:3] == "-1"):
            ...
            nodes[elem] = (nodes_x, nodes_y, nodes_z)
        ...
        if line[5:9] == "DISP":
            ...
            logging.info('Step time {}, U'.format(timetemp))
        if mode_disp_found and (line[1:3] == "-1"):
            ...
            mode_disp[elem] = (mode_disp_x, mode_disp_y, mode_disp_z)

        # Check if we found stress section
        if line[5:11] == "STRESS":
            mode_stress_found = True
            logging.info('Step time {}, S'.format(timetemp))
        ...
        if line[5:13] == "TOSTRAIN":
            ...
            logging.info('Step time {}, E'.format(timetemp))
        ...
        if line[5:7] == "PE":
            ...
            logging.info('Step time {}, PE'.format(timetemp))
        ...
        if line[5:11] == "NDTEMP":
            ...
            logging.info('Step time {}, T'.format(timetemp))
        ...
        if line[5:11] == "MAFLOW":
            ...
            logging.info('Step time {}, MAFLOW'.format(timetemp))
        ...
        if line[5:11] == "STPRES":
            ...
            logging.info('Step time {}, STPRES'.format(timetemp))
    ...
    if not nodes:
        logging.error("FEM: No nodes found in Frd file.\n")
